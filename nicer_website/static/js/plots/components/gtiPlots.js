...
function showGTIPlotSelectionPopup(obsID, selectedGTIs) {
  ...
  $form.on('submit', function (event) {
    ...
    // 🟢 RAHUL'S RESTORED LOGIC: Precise operation tracking
...
export function fetchGTIPlot(event) {
  ...
  // 🟢 RAHUL'S RESTORED LOGIC: Complete existing operations by pattern
  ...
  const updatePlot = (currentPlotType, currentOperationId) => {
    ...
    return $.ajax({
      ...
      success: function (data) {
        ...
        // 🟢 RAHUL'S RESTORED LOGIC: Finish operation and clear pattern
      ...
      error: function (xhr, status, error) {
        ...
        // 🟢 RAHUL'S RESTORED LOGIC: Error handling in operation tracker
        if (currentOperationId) {
  ...
  // 🟢 RAHUL'S RESTORED LOGIC: Loop through open plot types to update
...
export function combineAndPlotGTIs(event) {
  ...
  // 🟢 RAHUL'S RESTORED LOGIC: Start operation for combining
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      if (data.plotDivs && data.plotDivs.length > 0) {
        ...
        // 🟢 RAHUL'S RESTORED LOGIC: Success tracking
    ...
    complete: function () {
      // Operation completion handled in success/error
    },
  });
}