/* * graph.js v200 - Full Merged Master
* Keeps your Modular Imports + Combined Title Logic
* Integrates Rahul's GTI Form stability & Detailed Status reporting
*/
...
export function fetchGraphPlots(refresh = false, event) {
    ...
    // 🟢 RAHUL IMPROVEMENT: Clear status reporting
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (hasPlotTypes && response.plotDivs && response.plotDivs.length > 0) {
                ...
                // 🟢 RAHUL IMPROVEMENT: Detailed success message
